...
class CSurfaceRendererBasic:
	public CSurfaceRenderer
{
protected:
...
public:
	...
	enum EParameter {
		PARAMETER_BASE = CSurfaceRenderer::MAX_NR_OF_PARAMETERS,
	...
	*/
	...
	CSurfaceRendererBasic(void);
	virtual ~CSurfaceRendererBasic(void);
};
