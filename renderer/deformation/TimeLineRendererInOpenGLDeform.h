...
class CTimeLineRendererInOpenGLDeform :
	public CLineRendererInOpenGLDeform
{
protected:
...
public:
	enum EParameter {
		PARAMETER_BASE = CTimeLineRendererInOpenGLDeform::MAX_NR_OF_PARAMETERS,
	...
	CTimeLineRendererInOpenGLDeform(void);
	virtual ~CTimeLineRendererInOpenGLDeform(void);
};
