...
void 
CTimeLineRendererInOpenGLDeform::_SetInteger(int iParameter,	int iValue)
{
	switch(iParameter)
	{
	...
	CLineRendererInOpenGLDeform::_SetInteger(iParameter, iValue);
}

void 
CTimeLineRendererInOpenGLDeform::_GetInteger(int iParameter,	int* piValue)
{
	switch(iParameter)
	{
	case TIME_VARYING_ON:
		*piValue = int(bIsTimeVaryingOn);
		break;
	default:
		CLineRendererInOpenGLDeform::_GetInteger(iParameter, piValue);
	}
}

void 
CTimeLineRendererInOpenGLDeform::_SetFloat(int iParameter,	float fValue)
{
	switch(iParameter)
	{
	case MIN_TIME_STEP:
	...
	CLineRendererInOpenGLDeform::_SetFloat(iParameter, fValue);
}

void 
CTimeLineRendererInOpenGLDeform::_GetFloat(int iParameter,	float* pfValue)
{
	switch(iParameter)
	{
	case MIN_TIME_STEP:
	...
	case MAX_TIME_STEP:
		*pfValue = fMaxTimeStep;
		break;
	default:
		CLineRendererInOpenGLDeform::_GetFloat(iParameter, pfValue);
	}
}

void 
CTimeLineRendererInOpenGLDeform::_TraversePoint(int iPointIndex, int iTraceIndex, float fX, float fY, float fZ, float fT)
{
...
void 
CTimeLineRendererInOpenGLDeform::_TraverseLines()
{
...
CTimeLineRendererInOpenGLDeform::CTimeLineRendererInOpenGLDeform(void)
{
}
